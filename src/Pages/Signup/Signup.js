...
const Signup = () => {
    ...
    return (
        <div className="mx-auto w-full max-w-md p-8 space-y-3 rounded-xl bg-slate-300">
                ...
                <form onSubmit={handleSubmit} novalidate="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text"  name="photoURL" placeholder="Phot URL"className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
